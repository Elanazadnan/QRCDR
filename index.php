...
<html lang="<?php echo $lang; ?>" dir="<?php echo $rtl['dir']; ?>">
    ...
    <body class="<?php echo $body_class; ?>">
        ...
        if (file_exists(dirname(__FILE__).'/'.$relative.'template/footer.php')) {
            ...
            ?>
        <!-- here tan9iz line and developer me -->
            <br><br> <br> <br>
            <div class="pt-3"id="s">
            <div class="container" >
            <div class="row py-2 small mb-3">
            <div class="col-6">
             <h6> <?php echo qrcdr()->getString('title').' &copy; '.date('Y'); ?> </h6>
            </div>
            <div class="col-6 text-end">
          <h6>  <a href="http://elanazadnan.kesug.com/Me/" target="_blank">Developed by Adnan</a> </h6> 
            </div>
          </div>
          <div class="row py-2">
      <div class="col">
